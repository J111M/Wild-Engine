...
namespace Wild
{
    RootSignatureBuilder& RootSignatureBuilder::AddConstants(uint32_t num32BitValues, uint32_t shaderRegister, uint32_t space,
    ...
    RootSignatureBuilder& RootSignatureBuilder::AddDescriptorTable(const std::vector<D3D12_DESCRIPTOR_RANGE>& ranges,
                                                                   D3D12_SHADER_VISIBILITY visibility)
    {
