...
namespace Wild
{
    ...
    {
        template <typename ResourceType> void Register(ResourceType *value, const std::string& key);

        template <typename ResourceType> ResourceType& Get(const std::string& key) const;

        template <typename ResourceType> bool TryGet(const std::string& key, ResourceType *& out) const;

        template <typename ResourceType> void Replace(ResourceType *value, const std::string& key);

        template <typename ResourceType> void RegisterOrReplace(ResourceType *value, const std::string& key);
    ...
    template <typename ResourceType> inline void Blackboard::Register(ResourceType *value, const std::string& key)
    {
        if (HasValue(key))
        {
    ...
    template <typename ResourceType> inline ResourceType& Blackboard::Get(const std::string& key) const
    {
    ...
    template <typename ResourceType> inline bool Blackboard::TryGet(const std::string& key, ResourceType *& out) const
    {
    ...
    template <typename ResourceType> inline void Blackboard::Replace(ResourceType *value, const std::string& key)
    {
        if (!HasValue(key))
        {
    ...
    template <typename ResourceType> inline void Blackboard::RegisterOrReplace(ResourceType *value, const std::string& key)
    {
